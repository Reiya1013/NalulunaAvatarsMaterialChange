...
{
    class NalulunaMaterialChange
    {
        internal static NalulunaMaterialChange instance { get; private set; } = new NalulunaMaterialChange();
        ...
        {
            //assetシェーダーを読み込む
            AssetBundle assetBundle = AssetBundle.LoadFromStream(Assembly.GetExecutingAssembly().GetManifestResourceStream("NalulunaAvatarsMaterialChange.bs_shaders"));
        ...
        public void VRMCopy(bool WPosSet)
        {
            ...
            GameObject setAvataraObj = GameObject.Find("NalulunaAvatarsMaterialChange");
            //GameObject activeFalse1 = GameObject.Find("NalulunaAvatars/RoomAdjust");
