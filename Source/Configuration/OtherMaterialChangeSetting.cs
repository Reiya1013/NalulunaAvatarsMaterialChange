...
namespace NalulunaAvatarsMaterialChange
{
    public class OtherMaterialChangeSetting
    {
        ...
        public static readonly string configurationFile = Path.Combine(Application.dataPath, @"..\UserData\NalulunaAvatarsMaterialChange_Other.json");
    ...
    public class SettingOther
    {
        ...
        public bool IsAmbientLight = false;
        public float VMCLightBoost = 0.3f;
        public float AmbientLightBoost = 0.8f;
